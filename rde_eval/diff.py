...
def build_semantic_diff(sample: RdeSample) -> SemanticDiff:
    ...
    return SemanticDiff(
        ...
        responsibility_marker_removed=source.has_responsibility_marker and not output.has_responsibility_marker,
        theoretical_marker_removed=source.has_theoretical_marker and not output.has_theoretical_marker,
    )
